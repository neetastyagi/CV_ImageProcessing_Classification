...
def part_1():
    ...
    input_images = ['simple_tl', 'scene_tl_1', 'scene_tl_2', 'scene_tl_3', 'tl_green_299_287_background', 'tl_red_199_137_background','tl_yellow_199_237_background']
#    input_images = ['simple_tl']
    output_labels = ['ps2-1-a-1', 'ps2-1-a-2', 'ps2-1-a-3', 'ps2-1-a-4', 'ps2-1-a-5', 'ps2-1-a-6', 'ps2-1-a-7']
...
def part_2():
    ...
    for img_in, label, fn, name in zip(input_images, output_labels, sign_fns,
        ...
        if sign_labels[0] == 'no_entry':
                    dne_cord = ps2.do_not_enter_sign_detection(sign_img)
                    temp_dict['no_entry'] = dne_cord
